 ...
 */
final class Version20241103173302 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE event (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, address VARCHAR(255) NOT NULL, zip_code VARCHAR(5) NOT NULL, city VARCHAR(100) NOT NULL, start_date DATETIME NOT NULL, end_date DATETIME NOT NULL, banner LONGTEXT DEFAULT NULL, weez_event_id INT DEFAULT NULL, archived TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        ...
        $this->addSql('CREATE TABLE exhibitor (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, first_name VARCHAR(255) NOT NULL, last_name VARCHAR(255) NOT NULL, archived TINYINT(1) NOT NULL, exhibitor_group_id INT DEFAULT NULL, UNIQUE INDEX UNIQ_B2A03D20E7927C74 (email), INDEX IDX_B2A03D205C043938 (exhibitor_group_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('CREATE TABLE exhibitor_group (id INT AUTO_INCREMENT NOT NULL, group_name VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, website TINYTEXT DEFAULT NULL, email_contact VARCHAR(180) NOT NULL, archived TINYINT(1) NOT NULL, event_id INT DEFAULT NULL, UNIQUE INDEX UNIQ_3254E223F1A28EF7 (email_contact), INDEX IDX_3254E22371F7E88B (event_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
